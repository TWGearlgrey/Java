...
public class WrapperTest {
	public static void main(String[] args) {
		...
		// Wrapper 포장(Boxing) ~> 객체로 만들기, 컬렉션에서 다루기 위해 객체로 만듦.
		Integer box1 = var1; // Integer box1 = new Integer(var1);
		Double 	box2 = var2; // 취소선(Deprecate)이 생기는 경우 버전 문제
		Boolean box3 = var3;
		...
		Boolean w3 = Boolean.parseBoolean(str3); // parse~로 해도 된다. 하지만 위 두개처럼 하는게 좋음
