...
public class RegularExpressionTest {
	public static void main(String[] args) {
		...
		boolean r1 = Pattern.matches(strPatt, "apple"); // (정규식, 검증할 문자열)
		...
		String[] words = {"apple", "123한글", "123456", "011", "hello", 
										"홍길동", "1", "Banana", "apple", "APPLE", "#"};
		...
		// 자주 사용하는 정규표현식(^시작, $종결 의미)
		String ptt1 = "^[a-zA-Z0-9]*$";			// 아이디에 주로 사용
		String ptt2 = "^[가-힣]*$";				// 이름에 주로 사용
		String ptt3 = "(01\\d{1})-(\\d{3,4})-(\\d{4})";	
					// (01로 시작하면서 숫자 1개)-(숫자 3개 또는 4개)-(숫자 4개)	
		String ptt4 = "(\\w+)@(\\w+).(\\w+)";	// 
