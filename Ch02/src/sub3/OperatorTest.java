...
public class OperatorTest {
	public static void main(String[] args) {
		...
		int result4 = num4 / num2; // 정수형이기때문에 몫만 나옴		
		int result5 = num4 % num3; // 나머지를 구하는 연산자(%), 4 % 5라면 4가 나옴
		...
		// 2. 증감연산자
		int num = 0; // 'int=num'은 변수 선언, 'num=0'은 초기화. 여기선 동시에 했다.
		
		num++; // 증감연산자 앞 뒤 차이가 있음
		++num;
		...
		n1 += 1; // n1 = n1 + 1; ~> 참조를 한 번 하냐, 두 번 하냐의 차이
		n2 -= 2; // n2 = n2 - 2;
		n3 *= 3; // n3 = n3 * 3;
		n4 /= 4; // n4 = n4 / 4;
		...
		boolean res4 = (var3 > 3) || (var4 > 5); // var3는 3보다 크거나 var4는 5보다 작다.
